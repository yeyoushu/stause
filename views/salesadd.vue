  ...
  <div>
    ...
    >
      ...
      <span style="display: none">
        {{
          (pomain.soTotal =
            parseInt(pomain.productTotal) + parseInt(pomain.tipFee))
        }}
      </span>
      <div class="demo">
...
export default {
  ...
  methods: {
    ...
    getRandomInt(min, max) {
      ...
      this.pomain.soId = Math.floor(Math.random() * (max - min + 1)) + min;
    ...
    handleEdit(index, row) {
      ...
      if ((row.index = !row.index)) {
        ...
        this.pomain.soitems[this.currentIndex].unitPrice = 0;
      } else {
        alert("请勿重复添加");
      }
