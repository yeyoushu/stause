<template>
  ...
  <el-breadcrumb-item>月度入库报表</el-breadcrumb-item>
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column label="入库单据数" width="180">
    ...
    <el-table :data="tableDataa" style="width: 100%">
      ...
      <el-table-column label="采购单编号" width="190">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getMessage() {
      ...
      axios
        .get(
          "/cgi/main/report/instock/main?" + querystring.stringify(this.value)+'&page='+this.currentPage
        )
        .then((value) => {
